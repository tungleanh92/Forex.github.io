 ...
 */
 ...
 $("._circle_oclock").final_countdown({
    'start': 0,
    'end': 30000,
    'now': 0
  });
    ...
    function prepareCounters() {
        ...
        circleSeconds = new Kinetic.Shape({
            drawFunc: function (context) {
                ...
                if ((60 - timer.seconds) < 10) {
                    $(settings.selectors.value_seconds).html("0" + (60 - timer.seconds).toString());
                } else {
        ...
        circleMinutes = new Kinetic.Shape({
            drawFunc: function (context) {
                ...
                if ((60 - timer.minutes) < 10) {
                    $(settings.selectors.value_minutes).html("0" + (60 - timer.minutes).toString());
                } else {
        ...
        circleHours = new Kinetic.Shape({
            drawFunc: function (context) {
                ...
                context.fillStrokeShape(this);
                if ((24 - timer.hours) < 10) {
                    $(settings.selectors.value_hours).html("0" + (24 - timer.hours).toString());
                } else {
        ...
        circleDays = new Kinetic.Shape({
            drawFunc: function (context) {
                ...
                context.fillStrokeShape(this);
                if ((timer.days) < 10) {
                    $(settings.selectors.value_days).html("0" + timer.days.toString());
                } else {
